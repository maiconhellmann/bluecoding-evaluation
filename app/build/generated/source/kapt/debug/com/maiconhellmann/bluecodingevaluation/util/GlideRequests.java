...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.maiconhellmann.bluecodingevaluation.util.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.maiconhellmann.bluecodingevaluation.util.GlideOptions().apply(toSet));
    }
  }
}
